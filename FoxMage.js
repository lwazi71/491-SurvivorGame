class FoxMage {
    ...
    loadAnimations() {
        ...
        //RIGHT
        //idle
        this.animations[0][0] = new Animator(ASSET_MANAGER.getAsset("./Sprites/Mages/FoxMage.png"), 0, 0, 32, 32, 4, 0.2, false, true);

        //walking
        this.animations[1][0] = new Animator(ASSET_MANAGER.getAsset("./Sprites/Mages/FoxMage.png"), 0, 32, 32, 32, 8, 0.1, false, true);

        //casting
        this.animations[2][0] = new Animator(ASSET_MANAGER.getAsset("./Sprites/Mages/FoxMage.png"), 0, 64, 32, 32, 8, 0.1, false, true);

        //damaged
        this.animations[3][0] = new Animator(ASSET_MANAGER.getAsset("./Sprites/Mages/FoxMage.png"), 32, 96, 32, 32, 3, 0.2, false, true);

        //LEFT
        //idle
        this.animations[0][1] = new Animator(ASSET_MANAGER.getAsset("./Sprites/Mages/FoxMage-Flipped.png"), 0, 0, 32, 32, 8, 0.2, true, true);

        //running
        this.animations[1][1] = new Animator(ASSET_MANAGER.getAsset("./Sprites/Mages/FoxMage-Flipped.png"), 0, 32, 32, 32, 8, 0.1, true, true);

        //casting
        this.animations[2][1] = new Animator(ASSET_MANAGER.getAsset("./Sprites/Mages/FoxMage-Flipped.png"), 0, 64, 32, 32, 8, 0.1, true, true);
