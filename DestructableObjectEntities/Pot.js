class Pot {
    constructor(game, x, y, drop) { //the drop will let us know whether to drop coins, an item, or nothing
        ...
        this.dead = false;
        this.deathAnimationTimer = 3.9 * 0.15;
    ...
    updateBB() {
        this.BB = new BoundingBox((this.x + 56), (this.y + 57), 22, 27);
    }

    loadAnimations() {
        //idle
        this.animations[0] = new Animator(this.spritesheet, 0, 256, 63.3, 63.3, 0.9, 0.15, false, true);

        //hit animation
        this.animations[1] = new Animator(this.spritesheet, 64, 256, 63.3, 63.3, 1.9, 0.1, false, true);

        //destroyed animation
        this.animations[2] = new Animator(this.spritesheet, 192, 318, 64, 64, 3.9, 0.15, false, false);
    ...
    draw(ctx) {
        ...
        ctx.drawImage(this.shadow, 0, 0, 64, 32, (this.x + 53) - this.game.camera.x, (this.y + 72) - this.game.camera.y, 28, 16);
