class Crate {
    ...
    updateBB() {
        this.BB = new BoundingBox((this.x + 53), (this.y + 53), 32, 35);
    }

    loadAnimations() {
        //idle
        this.animations[0] = new Animator(this.spritesheet, 0, 128, 63.3, 63.3, 0.9, 0.15, false, true);

        //hit animation
        this.animations[1] = new Animator(this.spritesheet, 64, 128, 63.3, 63.3, 1.9, 0.1, false, true);

        //destroyed animation
        this.animations[2] = new Animator(this.spritesheet, 192, 192, 63.3, 63.3, 4, 0.15, false, false);       
    }
    ...
    draw(ctx) {
        ...
        ctx.drawImage(this.shadow, 0, 0, 64, 32, (this.x + 51) - this.game.camera.x, (this.y + 82) - this.game.camera.y, 36, 16);
