class Ghoul {
    constructor(game) {
        ...
        this.spriteSheet = ASSET_MANAGER.getAsset("./Sprites/Mobs/Blue Ghoul/Shardsoul Slayer Sprite Sheet.png");
        ...
        this.animations = {
            idle: { row: 0, frames: 8, duration: 0.2 },
            movement: { row: 1, frames: 8, duration: 0.15 },
            attack: { row: 2, frames: 5, duration: 0.25 },
