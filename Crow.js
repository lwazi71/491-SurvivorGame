class Crow {
    ...
    loadAnimation() {
        ...
        this.animations[0][0] = new Animator(ASSET_MANAGER.getAsset("./Sprites/Crow/crow_idle.png"), 0, 0, 64, 64, 3.9, 0.2, false, true);

        //Walking, looking right
        this.animations[1][0] = new Animator(ASSET_MANAGER.getAsset("./Sprites/Crow/crow_walk.png"), 0, 0, 64, 64, 3.9, 0.09, false, true);

        //Attack, to the right
        this.animations[2][0] = new Animator(ASSET_MANAGER.getAsset("./Sprites/Crow/crow_attack.png"), 0, 0, 64, 64, 4.9, 0.08, false, true);
        ...
        this.animations[0][1] = new Animator(ASSET_MANAGER.getAsset("./Sprites/Crow/crow_idle-flipped.png"), 5, 0, 64, 64, 3.9, 0.2, true, true);

        //Walking, looking left
        this.animations[1][1] = new Animator(ASSET_MANAGER.getAsset("./Sprites/Crow/crow_walk-flipped.png"), 5, 0, 64, 64, 3.9, 0.09, true, true);

        //Attack, to the left
        this.animations[2][1] = new Animator(ASSET_MANAGER.getAsset("./Sprites/Crow/crow_attack-flipped.png"), 5, 0, 64, 64, 4.9, 0.08, true, true);
